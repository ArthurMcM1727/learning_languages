...
class Program
{
    static void Main(string[] args)
    {
        ...
        int pointCount = 200; // Number of vertices
    ...
    static IEnumerable<DefaultTriangulationCell<Vertex, DefaultTriangulationCell<Vertex, object>>> Triangulate(List<Vertex> points)
    {
        return DelaunayTriangulation<Vertex, DefaultTriangulationCell<Vertex, object>>.Create(points).Cells;
    }
